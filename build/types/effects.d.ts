...
export type EdgeDotEffectConfig = {
    ...
    opacity: number;
    blendMode: CanvasRenderingContext2D['globalCompositeOperation'];
    animation: Partial<Pick<AnimationOptions<number>, 'delay' | 'clamp' | 'round' | 'easeAmount' | 'interpolationFunction' | 'interpolationFunctionParameters'>>;
};
...
export type GraphBuilderEffectsOptionsInput = Partial<Omit<GraphBuilderEffectsOptions, 'edgeDash' | 'edgeDot' | 'portPulse'>> & {
...
export type EdgeDashEffectsController = {
    get: (target: EdgeEffectTarget, channel?: GraphEffectChannel) => EdgeDashEffectConfig | null;
    set: (target: EdgeEffectTarget, patch: Partial<EdgeDashEffectConfig>, channel?: GraphEffectChannel) => boolean;
    start: (target: EdgeEffectTarget, patch?: Partial<EdgeDashEffectConfig>, channel?: GraphEffectChannel) => boolean;
...
export type EdgeDotEffectsController = {
    get: (target: EdgeEffectTarget, channel?: GraphEffectChannel) => EdgeDotEffectConfig | null;
    set: (target: EdgeEffectTarget, patch: Partial<EdgeDotEffectConfig>, channel?: GraphEffectChannel) => boolean;
    trigger: (target: EdgeEffectTarget, patch?: Partial<EdgeDotEffectConfig>, channel?: GraphEffectChannel) => EffectTriggerHandle | null;
    start: (target: EdgeEffectTarget, patch?: Partial<EdgeDotEffectConfig>, channel?: GraphEffectChannel) => boolean;
    stop: (target: EdgeEffectTarget, channel?: GraphEffectChannel) => boolean;
    clear: (target?: EdgeEffectTarget, channel?: GraphEffectChannel) => void;
};
export type PortPulseEffectsController = {
    trigger: (target: PortEffectTarget, patch?: Partial<PortPulseEffectConfig>, channel?: GraphEffectChannel) => EffectTriggerHandle | null;
