...
A vector and matrix library.

All operations are immutable. Functions return new instances rather than modifying inputs.

## Installation

```bash
npm install @basementuniverse/vec
```
